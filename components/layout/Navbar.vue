    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
      <div class="flex justify-between  border-b-2 border-gray-100">
        ...
        <div class="flex justify-between space-x-5 align-bottom mt-14">
          <span class="hidden md:block cursor-pointer" @click="setColorTheme($colorMode.preference == 'dark' ? 'light' : 'dark')">
        ...
        <div class="flex justify-between space-x-5 align-bottom mt-14" v-if="authStore.access_token">
          <span class="hidden md:block cursor-pointer" @click="logout()">
