  ...
  <div>
    <div class="container mx-auto" v-if="!authStore.access_token">
      <div id="login" class="text-content-between m-5">
        <h1 class="text-xl m-2 dark:text-white">Ingresa para buscar tu canción favorita</h1>
        <button class="bg-green-400 px-4 py-2 rounded-3xl text-black" @click="login()">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-10" version="1.1" viewBox="0 0 559 168">
            <path fill="#fff"
